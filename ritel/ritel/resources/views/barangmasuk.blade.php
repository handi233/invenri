                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Stock Barang Masuk</h5>
                            </div>
                        <div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-hover mb-0 w-100">
                                        ...
                                        <tbody id="tableData">
                                             ...
                                             @foreach($masuk as $barang)
                                                <tr>
                                                    <td>{{ $barang->id_brng_masuk }}</td>
                                                    <td>{{ $barang->tgl }}</td>
                                                     <td>{{ $barang->nm_brng }}</td>
                                                    <td>{{ $barang->ket }}</td>
                                                    <td>{{ $barang->qty }}</td>  
                                                 <td><form action="{{ route('barangmasuk.del', $barang->id_masuk) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus barang ini?')">
                                                            @csrf
                                                            @method('DELETE')
                    ...
                    <div class="row g-3">
                        <div class="col-md-3 text-center">
                            <div class="p-3 border rounded">
                                ...
                                <br><small>Stock Barang Masuk</small>
                            </div>
                        </div>
                        <div class="col-md-3 text-center">
                            <div class="p-3 border rounded">
...
<div class="modal fade" id="myModal" tabindex="-10" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Stok Barang Masuk</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
    ...
    <div class="modal-body">
  <form id="myForm" action="{{ route('baranginput.input') }}" method="POST">
    <div class="mb-3">
     @csrf
    <div class="mb-3">
    ...
    $now = date('Y-m-d\TH:i'); 
     ...
     <div class="mb-3">
     <label for="nm_barang">ID Barang Masuk</label>
    <input type="text" class="form-control" id="id_brng_masuk" name="id_brng_masuk" required>
    </div>
    <div class="mb-3">
     <label for="nm_barang">Nama Barang</label>
    <input type="text" class="form-control" id="nm_brng" name="nm_brng" required>
    </div>
     <div class="mb-3">
      <label for="ket" class="form-label">Keterangan</label>
      <input type="text" class="form-control" id="ket" name="ket"  required></textarea>
    </div>
     <div class="mb-3">
      <label for="qty" class="form-label">Qty</label>
      <input type="number" class="form-control" id="qty" name="qty"  required min="1"></textarea>
    </div>
