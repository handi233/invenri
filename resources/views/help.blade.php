...
<div class="card shadow-sm border-0">
    <div class="card-body">
        ...
        <p class="card-text">
            Ini adalah halaman informasi sistem yaitu retail:
        </p>
        <ul>
            <li>Melihat stok barang saat ini</li>
            <li>Menambahkan barang masuk dan keluar</li>
            <li>Mengelola pengguna (untuk admin)</li>
            <li>Menambah akun dan control akses aktifitas users</li>
            <li>Mengakses pengaturan dan bantuan</li>
        </ul>
...
<div class="modal fade" id="myModal" tabindex="-10" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
  <form id="myForm" action="{{ route('baranginput') }}" method="POST">
    <div class="mb-3">
     @csrf
      <label for="nameInput" class="form-label">ID Masuk</label>
      <input type="text" class="form-control" id="id" name="id" placeholder="ID Masuk" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="stock" name="stock" placeholder="Isi Stock" required></textarea>
    </div>
