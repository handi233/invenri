        ...
        <main class="admin-main">
            ...
            <div class="container-fluid p-4 p-lg-5">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">                
                    <div>
                        <h1 class="h3 mb-0">Pengaturan User</h1>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h5 class="card-title mb-0">Peraturan Users</h5>
                            </div>
                        <div>
                                    ...
                                    <table class="table table-hover mb-0 w-100">
                                        ...
                                        <tbody id="tableData">
                                             ...
                                             @foreach($users as $users)
                                                <tr>
                                                    <td>{{ $users->id }}</td>
                                                    <td>{{ $users->fullnama }}</td>
                                                    <td>{{ $users->username }}</td>
                                                    <td>{{ $users->password }}</td>  
                                                 <td><form action="{{ route('users.del', $users->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus users ini?')">
                                                            @csrf
                                                            @method('DELETE')
...
<div class="modal fade" id="myModal" tabindex="-10" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Menambah Users</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
    ...
    <div class="modal-body">
  <form id="myForm" action="{{ route('users.input')}}" method="POST">
    <div class="mb-3">
     @csrf
      <label for="fullnama" class="form-label">Nama Lengkap</label>
      <input type="text" class="form-control" id="fullnama" name="fullnama" placeholder="Nama Lengkap" required>
    </div>
    <div class="mb-3">
