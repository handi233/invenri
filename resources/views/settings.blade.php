                           ...
                           Edit
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                     <!-- Input Search -->
                                    <input class="form-control mb-3" id="searchInput" type="text" placeholder="Cari Users...">
                                        ...
                                        <tbody id="tableData">
                                             ...
                                             @foreach($settings as $setting)
                                                <tr>
                                                    ...
                                                    <td>{{ $setting->alamat_instansi }}</td>
                                                    <td>{{ $setting->background }}</td>  
                                                 <td><form action="{{ route('settings.del', $setting->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus users ini?')">
                                                            @csrf
                                                            @method('DELETE')
...
<div class="modal fade" id="myModal" tabindex="-10" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
  <form id="myForm" action="{{ route('settings.update' , $setting->id)}}" method="POST">
    <div class="mb-3">
     @csrf
      @method('PUT')
      <label for="nama" class="form-label">Nama Instansi</label>
      <input type="text" class="form-control" id="nama" name="nama_instansi" value="{{ $setting->nama_instansi }}" required>
    </div>
    <div class="mb-3">
      <label for="alamat" class="form-label">Alamat Instansi</label>
      <input type="text" class="form-control" id="alamat" name="alamat_instansi" value="{{ $setting->alamat_instansi }}" required>
    </div>
    <div class="mb-3">
      <label for="background" class="form-label">Background Gambar</label>
      <input type="text" class="form-control" id="background" name="background" value="{{ $setting->background }}" required></textarea>
    </div>
